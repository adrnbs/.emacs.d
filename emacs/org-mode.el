;;; org-mode.el --- Houses configuration for org/todo mode(s)
;;; Commentary:
;;; Emacs startup include file, initialized from within init.el
...
(setq org-agenda-files (quote ("~/git/orgbinder"
			       "~/git/orgfiles"
			       "~/git/orgfiles/p")))
...
(setq org-agenda-diary-file "~/git/orgfiles/diary.org")
